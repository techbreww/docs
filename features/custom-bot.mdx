...
<Steps>
  ...
  <Step title="Authorize command permissions">
    A Discord pop-up opens asking you to authorize the bot for your server. This grants the bot the specific permissions it needs to operate — including managing roles, channels, messages, and voice.
