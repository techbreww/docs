...
<Steps>
  ...
  <Step title="Authorize command permissions">
    A Discord pop-up opens asking you to authorize the bot for your server. This grants the bot permission to sync slash commands between the dashboard and Discord.
