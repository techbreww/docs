...
Teams let you collaborate with other people on managing your Discord servers through the [BrewBot Dashboard](https://brewbot.techbrew.dev). Each team is a separate workspace with its own members, servers, and settings.
...
<Steps>
  <Step title="Open the teams page">
    Go to the [dashboard](https://brewbot.techbrew.dev) and navigate to the **Teams** page.
  </Step>
